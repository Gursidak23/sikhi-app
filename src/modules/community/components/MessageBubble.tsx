    ...
    return (
      <div className="flex items-center gap-2 px-4 py-2 opacity-50">
        <span className="text-xs text-gray-400 italic">
          {isPunjabi ? '🗑️ ਸੁਨੇਹਾ ਮਿਟਾਇਆ ਗਿਆ' : '🗑️ Message deleted'}
        </span>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className={cn('max-w-[75%] min-w-0', isOwn && 'text-right')}>
        ...
        {message.replyTo && (
          <div className={cn(
            'mb-1 px-3 py-1.5 rounded-lg text-xs bg-gray-100 dark:bg-gray-700 border-l-3 border-amber-400',
            isOwn ? 'ml-auto' : ''
          )}>
        ...
        <div
          className={cn(
            'inline-block px-4 py-2.5 rounded-2xl text-sm leading-relaxed break-words whitespace-pre-wrap',
            isOwn
